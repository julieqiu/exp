...
// Package commandyaml provides utilities for generating gcloud command configurations and related types.
package commandyaml
...
type Command struct {
	ReleaseTracks []gcloudconfig.ReleaseTrack `yaml:"release_tracks,omitempty"`
